...
const translations = {
    tr: {
        nav_home: "Ana Sayfa", nav_about: "Hakkımda", nav_skills: "Yetenekler", nav_exp: "Deneyim", nav_eba: "eBA Süreçleri", nav_ref: "Referanslar", nav_cert: "Sertifikalar", nav_extra: "Ek Bilgiler",
        ...
        cert_title1: "Sahip Olduğum", cert_title2: "Sertifikalar",
        cert_1_title: "SQL İle Veritabanı Sorgulama 101", cert_1_inst: "Turkcell Akademi - 23.04.2026",
        cert_2_title: "İlişkisel Veritabanlarında Sorgulama 201", cert_2_inst: "Turkcell Akademi - 25.04.2026",
    ...
    en: {
        ...
        cert_title1: "My", cert_title2: "Certificates",
        cert_1_title: "Database Querying with SQL 101", cert_1_inst: "Turkcell Academy - 04.23.2026",
        cert_2_title: "Querying in Relational Databases 201", cert_2_inst: "Turkcell Academy - 04.25.2026",
...
ScrollReveal().reveal('.skills-row, .company-container, .cards-container, .info-grid, .certSwiper', { origin: 'bottom' });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    /* =========================================
       SERTİFİKA ZOOM MODALI (YENİ EKLENDİ)
    ========================================= */
    const imageModal = document.getElementById("imageModal");
    const zoomedImg = document.getElementById("zoomedImg");
    const closeModal = document.querySelector(".close-modal");

    // Tüm sertifika resimlerine tıklama eventi eklendi
    document.querySelectorAll('.cert-box img').forEach(img => {
        img.addEventListener('click', function() {
            imageModal.classList.add("show");
            zoomedImg.src = this.src; // Tıklanan resmi modala aktar
        });
    });

    // Çarpı butonuna tıklayınca kapat
    if(closeModal) {
    ...
    // Resmin dışına (karanlık alana) tıklayınca kapat
